...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <br><strong>Seja Rei!</strong></h2>
            ...
            <div class="flex">
                <img alt="Cliente 1" loading="lazy" decoding="async" data-nimg="1" class="rounded-full imgclient border border-white" style="color:transparent" src="/modules/addons/custom_features_for_whmcs_sourei/public/img/profile1.jpg">
                <img alt="Cliente 2" loading="lazy" decoding="async" data-nimg="1" class="rounded-full imgclient border border-white ml" style="color:transparent" src="/modules/addons/custom_features_for_whmcs_sourei/public/img/profile2.png">
                <img alt="Cliente 3" loading="lazy" decoding="async" data-nimg="1" class="rounded-full imgclient border border-white ml" style="color:transparent" src="/modules/addons/custom_features_for_whmcs_sourei/public/img/profile3.png">
            </div>
